...
#define DEFAULT_MAX_PACKET_SIZE                      4
#define DEFAULT_MIN_PACKET_SIZE                      4
#define DEFAULT_ROUTING_ALGORITHM         ROUTING_LBDR
#define DEFAULT_ROUTING_TABLE_FILENAME              ""
#define DEFAULT_SELECTION_STRATEGY          SEL_BUFFER_LEVEL
#define DEFAULT_PACKET_INJECTION_RATE             0.08
#define DEFAULT_PROBABILITY_OF_RETRANSMISSION     0.08
