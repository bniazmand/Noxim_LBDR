...
SC_MODULE(NoximRouter)
{
    ...
    // LBDR Connectivitiy and Routing Bits
    bool                   C_n , C_e , C_w , C_s , C_u , C_d ;
    bool                   R_ne , R_nw , R_en , R_es , R_wn , R_ws , R_se , R_sw;

    // LBDR Signals
    bool                   N , E , W , S;
    bool                   N_prime , E_prime , W_prime , S_prime;
    bool                   N_zegond , E_zegond , W_zegond , S_zegond;
  ...
  private:
    ...
    vector < int >routingLBDR(const NoximCoord & current,
